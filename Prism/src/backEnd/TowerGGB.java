...
public class TowerGGB extends SimpleAOETower {
	
	public static final double PRIORITY = 0;
	public static final double MAX_HEALTH = 1100;
	...
	public static final double MULT_SLOW_STRENGTH = 1.8;
...
class SlowingDebuffGGB extends SlowingDebuffGB {

	Double penalty;
	
	public SlowingDebuffGGB() {
		super();
		penalty = new Double(TowerGGB.MULT_SLOW_STRENGTH);
	}
